...
- [The Rust Programming Language](https://doc.rust-lang.org/book/#the-rust-programming-language) / [中文版](https://kaisery.github.io/trpl-zh-cn/)
...
- [Tokio Internals](https://tony612.github.io/tokio-internals/02_boostrap.html)
- [How Tokio schedule tasks: A hard Lesson learnt](https://rustmagazine.org/issue-4/how-tokio-schedule-tasks/)
- [Tokio 的调度程序解释：Rust 如何处理数百万个任务](https://medium.com/@aayush71727/tokios-scheduler-explained-how-rust-handles-millions-of-tasks-c5e5d4b26259)
